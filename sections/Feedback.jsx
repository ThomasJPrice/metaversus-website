    ...
    >
      ...
      >
        ...
        <div>
          ...
          <p className="mt-[8px] font-normal sm:text-[18px] text-[12px] leading-[16px] sm:leading-[22px] text-white">Founder | Metaverus</p>
        </div>
        <p className="mt-[24px] font-normal sm:text-[24px] text-[18px] leading-[39px] sm:leading-[45px] text-white">
